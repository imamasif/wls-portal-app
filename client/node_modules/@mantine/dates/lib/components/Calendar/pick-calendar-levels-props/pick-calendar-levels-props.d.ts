export declare function pickCalendarProps<T extends Record<string, any>>(props: T): {
    calendarProps: {
        ...
        withCellSpacing: any;
        highlightToday: any;
        withNativeLevelSelect: any;
        yearsSelectRange: any;
