...
function useDidUpdate(fn, dependencies) {
	...
	const previousRender = (0, react.useRef)(null);
	const previousDependencies = (0, react.useRef)(void 0);
	const render = {};
	(0, react.useEffect)(() => {
